...
//		System.out.println(evalRPN(tokens2));
	...
	{
		// add all tokens to arraylist for easy manipulation
		ArrayList<String> list = new ArrayList<String>();
		
		for(int i = 0; i < tokens.length; i++)
			list.add(tokens[i]);
		
		// while there is not an answer (size = 1), find triples and do calculations
		while(list.size() != 1)
			findTrip(list, 0);
	...
	private static void findTrip(ArrayList<String> list, int i) {
//		
...
//		System.out.println();
		...
		// Find trips int, int, arithmetic_operation
		// make sure the 3rd item is an arithmetic operation
		// else move over 1 and find a trip
		// and then return so we can parse from the beginning
		if(!isArithOp(list.get(i + 2)))
		{
//			System.out.println("Not arith " + list.get(i+2));
			findTrip(list, i + 1);
			return;
		}
		
		// check to see int, int are indeed ints, else go to the next one
		// return so we can parse from the beginning again
		int k = 0, j = 0;
		
		try{
			k = Integer.parseInt(list.get(i));
			j = Integer.parseInt(list.get(i + 1));
		}catch(NumberFormatException e)
		{
//			System.out.println("ERR " + list.get(i) + " " + list.get(i+1));
			findTrip(list, i + 1);
			return;
		}
...
//		System.out.println();
		...
		// calculate answer
		int ans = arith(k, j, list.get(i+2));
		
//		System.out.println(k + list.get(i+2) + j + " = " + ans);
//		System.out.println("Removing " + list.get(i+2) + " & " + list.get(i+1));
//		System.out.println("Setting " + list.get(i) + " = " + ans);
		// set answer to first index, and remove the next 2 indices
		list.set(i, ans + "");
		list.remove(i + 1);
		list.remove(i + 1);
...
//		System.out.println("END");
	...
	private static int eval(int i, int j, String a) {		
		return 0;
//		if(list.size() == 1)
//			return Integer.parseInt(list.get(0));
//		
//		String a = list.get(index + 2);
//		String ans = "";
//		
//		if(isArithOp(a))
//		{
...
//			int j = 0;
//			try{
//				i = Integer.parseInt(list.get(index));
//				j = Integer.parseInt(list.get(index + 1));
//				
//			}catch(NumberFormatException e)
//			{
//				
...
//		list.remove(index);
//		System.out.println("inserting " + ans);
//		list.set(0, ans);
//	
...
//		return eval(list, 0);
	...
	private static int arith(int x, int y, String a) {
		if(a.equals("+"))
			return x + y;
		else if(a.equals("-"))
			return x-y;
